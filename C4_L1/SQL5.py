...
def add_new_Link(L):                            # Function Have Parameter
    links.append(L)                             # Add New Link In the Last links List
    link_index[L.id] = L                        # Add To link_index To Store The [Key --> id] And Get The [Value --> Full Info Of Link] When I Call It

L = Link(50, 1, 1, 1, "title", "url")           # New Link
add_new_Link(L)                                 # Send L Parameter To the Function add_new_Link

print links[-1]                                 # Last Link In links List
print link_by_id(50)                            # Search By ID Gat The Same Result Of links[-1]
