...
def query():
    c = db.execute("select * from links where id = 2")          # [* = All Columns from Table links where id = 2]

    link = Link(*c.fetchone())                              # * To Pass into Link Constructor and fetchone: To get first result
    return link.votes                                       # Return votes From Row Have ID = 2
